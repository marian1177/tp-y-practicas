class CuentaBancaria:
    def __init__(self,titular):
        ...
        self._saldo = 0  #valor por default del atributo a trabajar

    @property           #dato sensible protegido
    def obtener_saldo(self):
        return f"su saldo actual es {self._saldo}"
    
    def depositar(self,monto):   #metodo de modificacion donde se suma importe (validando billetes multiplos de 100 unicamente)
    ...
    def retirar(self,monto):  #metodo de modificacion donde se resta importe (validando billetes multiplos de 100 unicamente)
